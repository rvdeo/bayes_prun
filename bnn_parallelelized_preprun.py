...
from Bayesneuralnet_regcls_prun import MCMC, Network, scikit_linear_mod
...
def run_experiment(args):
    ...
    mcmc = MCMC(use_langevin_gradients, l_prob, learn_rate, numSamples, traindata, testdata, topology, prob_type,'stn',20)
...
def main():
    ...
    results_folder = "results/results_preprun"
    
    for problem in range(1, 2):  # Adjust according to the problem range you want to test
